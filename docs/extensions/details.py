...
def visit_details_node(self: Any, node: details) -> None:
    self.body.append(self.starttag(node, "details", CLASS=node.attributes.get("class", "")))


def visit_summary_node(self: Any, node: summary) -> None:
    self.body.append(self.starttag(node, "summary", CLASS=node.attributes.get("summary-class", "")))
    self.body.append(node.rawsource)


def depart_details_node(self: Any, node: details) -> None:
    self.body.append("</details>\n")


def depart_summary_node(self: Any, node: summary) -> None:
